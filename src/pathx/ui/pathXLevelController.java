...
public class pathXLevelController implements MouseListener, MouseMotionListener
{
     ...
     */
    public pathXLevelController(pathXDataModel initModel, pathXMiniGame initGame)
    {
 ...
 //       if (me.getButton() == MouseEvent.BUTTON3)
  //      {
   ...
   ////             model.switchEditMode(PXLE_EditMode.NOTHING_SELECTED);
    ...
    {
        // UPDATE THE POSITION
        data.setLastMouseX(me.getX());
        data.setLastMouseY(me.getY());//setLastMousePosition(me.getX(), me.getY());
    }
